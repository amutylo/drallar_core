 ...
 *
 * @RestResource(
 *   id = "get_outsourcing_node_resource",
 *   label = @Translation("Get outsourcing sector node resource"),
 *   uri_paths = {
 *     "canonical" = "/get/outsourcing/{id}"
 *   }
 * )
 */
class getOutsourcingSectorNodeResource extends ResourceBase {
  ...
  public function get(int $id) {
    ...
    if (!empty($node)) {
      ...
      $response['message'] = 'Outsourcing Sector node with provided ID is not found.';
